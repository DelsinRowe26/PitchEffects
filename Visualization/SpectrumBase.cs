...
namespace WinformsVisualization.Visualization//очень нужная вещь !!!!!!!!!!!!!!!!
{
    public class SpectrumBase : INotifyPropertyChanged
    {
        ...
        public int MaximumFrequency//Максимальная частота
        {
        ...
        public int MinimumFrequency//Минимальная частота
        {
        ...
        public ISpectrumProvider SpectrumProvider//Поставщик спектра
        {
        ...
        public bool IsXLogScale//Является ли X логарифмической шкалой
        {
        ...
        public ScalingStrategy ScalingStrategy//Стратегия масштабирования
        {
        ...
        [BrowsableAttribute(false)]
        public FftSize FftSize//Размер FFT
        {
        ...
        protected virtual void UpdateFrequencyMapping()//Обновление карт частот
        {
        ...
        protected virtual SpectrumPointData[] CalculateSpectrumPoints(double maxValue, float[] fftBuffer)//Вычислить точки спектра
        {
        ...
        protected void RaisePropertyChanged(string propertyName)//Поднять свойство изменено
        {
